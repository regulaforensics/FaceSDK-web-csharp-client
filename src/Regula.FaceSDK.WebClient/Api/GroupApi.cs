...
namespace Regula.FaceSDK.WebClient.Api
{
    ...
    public interface IGroupApi : IApiAccessor
    {
        ...
        /// <exception cref="Regula.FaceSDK.WebClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="groupId">Group id</param>
        /// <param name="body">Update group</param>
        /// <returns></returns>
        void UpdateGroup (decimal groupId, Model1groups1groupId body);
        ...
        /// <param name="body">Update group</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateGroupWithHttpInfo (decimal groupId, Model1groups1groupId body);
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateGroupAsync (decimal groupId, Model1groups1groupId body, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateGroupWithHttpInfoAsync (decimal groupId, Model1groups1groupId body, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Add/remove persons to group
        /// </summary>
        /// <remarks>
    ...
    public partial class GroupApi : IGroupApi
    {
        ...
        /// <param name="body">Update group</param>
        /// <returns></returns>
        public void UpdateGroup (decimal groupId, Model1groups1groupId body)
        {
        ...
        /// <param name="body">Update group</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateGroupWithHttpInfo (decimal groupId, Model1groups1groupId body)
        {
            // verify the required parameter 'groupId' is set
            if (groupId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateGroupAsync (decimal groupId, Model1groups1groupId body, CancellationToken cancellationToken = default(CancellationToken))
        {
             await UpdateGroupWithHttpInfoAsync(groupId, body, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateGroupWithHttpInfoAsync (decimal groupId, Model1groups1groupId body, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'groupId' is set
            if (groupId == null)
                throw new ApiException(400, "Missing required parameter 'groupId' when calling GroupApi->UpdateGroup");
