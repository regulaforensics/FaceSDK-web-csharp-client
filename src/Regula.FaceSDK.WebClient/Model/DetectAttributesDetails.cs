...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DetectAttributesDetails")]
    public partial class DetectAttributesDetails : DetailItem, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="name">The name of the attribute. (default to &quot;DetectAttributesDetails&quot;).</param>
        public DetectAttributesDetails(List<int> value = default(List<int>), string name = @"DetectAttributesDetails") : base(name)
        {
            this.Value = value;
        }
