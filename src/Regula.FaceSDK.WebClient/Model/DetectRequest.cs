...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class DetectRequest :  IEquatable<DetectRequest>, IValidatableObject
    {
        ...
        public DetectRequest(string tag = default(string), ProcessParam processParam = default(ProcessParam), byte[] image = default(byte[]), bool thumbnails = false, bool attributes = false)
        {
            this.Tag = tag;
