...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class DetectRequest :  IEquatable<DetectRequest>, IValidatableObject
    {
        ...
        public DetectRequest(string tag = default(string), ProcessParam processParam = default(ProcessParam), byte[] image = default(byte[]), string tenant = default(string), string env = default(string))
        {
            this.Tag = tag;
