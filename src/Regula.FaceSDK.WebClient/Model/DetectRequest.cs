...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class DetectRequest : TransactionLabels, IValidatableObject
    {
        /// <summary>
        ...
        public DetectRequest(string tag = default(string), ProcessParam processParam = default(ProcessParam), byte[] image = default(byte[]), string tenant = default(string), string env = default(string)) : base(tenant, env)
        {
            this.Tag = tag;
