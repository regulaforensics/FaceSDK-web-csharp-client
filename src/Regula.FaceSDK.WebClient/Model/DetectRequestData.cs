...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// DetectRequestData
    /// </summary>
    [DataContract(Name = "DetectRequestData")]
    public partial class DetectRequestData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectRequestData" /> class.
        /// </summary>
        ...
        public DetectRequestData(string tag = default(string), ProcessParam processParam = default(ProcessParam), byte[] image = default(byte[]))
        {
            this.Tag = tag;
