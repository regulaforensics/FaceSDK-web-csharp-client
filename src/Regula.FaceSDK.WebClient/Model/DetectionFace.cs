...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class DetectionFace :  IEquatable<DetectionFace>, IValidatableObject
    {
        ...
        public DetectionFace(decimal faceIndex = default(decimal), List<List<decimal>> landmarks = default(List<List<decimal>>), decimal rotationAngle = default(decimal), List<decimal> roi = default(List<decimal>), Object thumbnail = default(Object), byte[] crop = default(byte[]))
        {
