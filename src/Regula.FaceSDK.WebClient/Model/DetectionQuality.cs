...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class DetectionQuality :  IEquatable<DetectionQuality>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="aligned">Returns true if alignment was done. Otherwise, false..</param>
        /// <param name="compliant">Returns the portrait quality assessment result. True if all the checked characteristics returned values that fit into the range. Otherwise, false..</param>
        /// <param name="nonCompliant">nonCompliant.</param>
        /// <param name="detailsGroups">detailsGroups.</param>
        /// <param name="details">details.</param>
        /// <param name="resized">Returns true if the image was resized according to the set dimensions. Otherwise, false..</param>
        ...
        public DetectionQuality(bool aligned = default(bool), bool compliant = default(bool), List<FaceQualityConfigName> nonCompliant = default(List<FaceQualityConfigName>), List<QualityDetailsGroups> detailsGroups = default(List<QualityDetailsGroups>), List<QualityDetail> details = default(List<QualityDetail>), bool resized = default(bool), float score = default(float))
        {
        ...
        /// </summary>
        /// <value>Returns true if alignment was done. Otherwise, false.</value>
        ...
        /// </summary>
        /// <value>Returns the portrait quality assessment result. True if all the checked characteristics returned values that fit into the range. Otherwise, false.</value>
        [DataMember(Name="compliant", EmitDefaultValue=false)]
        public bool Compliant { get; set; }

        /// <summary>
        /// Gets or Sets NonCompliant
        /// </summary>
        [DataMember(Name="nonCompliant", EmitDefaultValue=false)]
        public List<FaceQualityConfigName> NonCompliant { get; set; }

        /// <summary>
        /// Gets or Sets DetailsGroups
        /// </summary>
        ...
        /// </summary>
        /// <value>Returns true if the image was resized according to the set dimensions. Otherwise, false.</value>
