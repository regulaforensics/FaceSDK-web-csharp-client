...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// </summary>
    /// <value>Face detection scenario. If set and the scenario is found, it automatically applies the relevant parameters, overriding any other parameters specified in the request. If the scenario is not set, is empty, or the name is not recognized, processing will follow the parameters directly set in the request. For detailed descriptions of available scenarios, refer to the [Scenarios page](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/usage/face-detection/scenarios/).</value>
    ...
    public enum FaceQualityScenarios
    {
        ...
        /// <summary>
        /// Enum ATTRIBUTES_ALL for value: AttributesAll
        /// </summary>
        [EnumMember(Value = "AttributesAll")]
        ATTRIBUTES_ALL = 9,
