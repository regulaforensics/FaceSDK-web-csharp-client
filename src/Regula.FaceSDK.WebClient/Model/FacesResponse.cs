...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class FacesResponse :  IEquatable<FacesResponse>, IValidatableObject
    {
        ...
        public FacesResponse(decimal faceIndex = default(decimal), List<List<decimal>> landmarks = default(List<List<decimal>>), List<decimal> roi = default(List<decimal>), byte[] thumbnail = default(byte[]), List<PersonWithImages> persons = default(List<PersonWithImages>), float rotationAngle = default(float))
        {
