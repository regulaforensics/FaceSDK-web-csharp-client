...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class FacesResponse :  IEquatable<FacesResponse>, IValidatableObject
    {
        ...
        public FacesResponse(decimal faceIndex = default(decimal), List<List<decimal>> landmarks = default(List<List<decimal>>), float rotationAngle = default(float), List<decimal> roi = default(List<decimal>), byte[] crop = default(byte[]), List<PersonWithImages> persons = default(List<PersonWithImages>))
        {
