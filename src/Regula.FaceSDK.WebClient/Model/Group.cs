...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class Group :  IEquatable<Group>, IValidatableObject
    {
        ...
        public Group(string name = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), decimal id = default(decimal), DateTime createdAt = default(DateTime))
        {
            this.Name = name;
