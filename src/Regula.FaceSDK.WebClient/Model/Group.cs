...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class Group : IValidatableObject
    {
        ...
        public Group(string tag = default(string), string name = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), Guid id = default(Guid), string createdAt = default(string))
        {
            this.Tag = tag;
            this.Name = name;
