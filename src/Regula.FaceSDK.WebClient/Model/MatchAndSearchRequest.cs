...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class MatchAndSearchRequest : IValidatableObject
    {
        ...
        public MatchAndSearchRequest(string tag = default(string), List<MatchAndSearchRequestImagesItem> images = default(List<MatchAndSearchRequestImagesItem>), List<Guid> groupIds = default(List<Guid>), decimal threshold = default(decimal), int limit = default(int), string tenant = default(string), string env = default(string))
        {
            this.Tag = tag;
            this.Images = images;
        ...
        public List<MatchAndSearchRequestImagesItem>? Images { get; set; }
