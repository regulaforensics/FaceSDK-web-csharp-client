...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// MatchImageResult
    /// </summary>
    [DataContract(Name = "MatchImageResult")]
    public partial class MatchImageResult : IValidatableObject
    {
        ...
        [DataMember(Name = "firstIndex", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The image index number. Can be given; if not given, the index numbers are set automatically starting from &#x60;0&#x60;. All index numbers must be whole and unique—not repeated.</value>
        [DataMember(Name = "secondIndex", IsRequired = true, EmitDefaultValue = true)]
