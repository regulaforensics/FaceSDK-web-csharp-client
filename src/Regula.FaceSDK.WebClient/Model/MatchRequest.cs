...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class MatchRequest :  IEquatable<MatchRequest>, IValidatableObject
    {
        ...
        public MatchRequest(string tag = default(string), Object thumbnails = default(Object), List<MatchImage> images = default(List<MatchImage>), OutputImageParams outputImageParams = default(OutputImageParams))
        {
