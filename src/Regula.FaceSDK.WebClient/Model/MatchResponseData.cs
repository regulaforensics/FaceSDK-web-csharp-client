...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// MatchResponseData
    /// </summary>
    [DataContract(Name = "MatchResponseData")]
    public partial class MatchResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchResponseData" /> class.
        /// </summary>
        ...
        public MatchResponseData(List<MatchImageDetection> detections = default(List<MatchImageDetection>), List<MatchImageResult> results = default(List<MatchImageResult>), Dictionary<string, Object> metadata = default(Dictionary<string, Object>))
        {
