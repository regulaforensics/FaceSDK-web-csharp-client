...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class Person :  IEquatable<Person>, IValidatableObject
    {
        ...
        public Person(string name = default(string), string externalId = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>), Guid id = default(Guid), string createdAt = default(string), string updatedAt = default(string))
        {
