...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class PersonData : IValidatableObject
    {
        /// <summary>
        ...
        public PersonData(Guid id = default(Guid), string createdAt = default(string), string updatedAt = default(string))
        {
            this.Id = id;
