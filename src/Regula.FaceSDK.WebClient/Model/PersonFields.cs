...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class PersonFields :  IEquatable<PersonFields>, IValidatableObject
    {
        ...
        public PersonFields(string name = default(string), string externalId = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>))
        {
