...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class PersonFields : IValidatableObject
    {
        ...
        public PersonFields(string name = default(string), string externalId = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>), string expireAt = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PersonFields and cannot be null");
            }
            this.Name = name;
