...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonToUpdateFields")]
    public partial class PersonToUpdateFields : IValidatableObject
    {
        /// <summary>
        ...
        public PersonToUpdateFields(string externalId = default(string), string name = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>))
        {
