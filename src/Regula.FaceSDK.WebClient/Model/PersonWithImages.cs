...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class PersonWithImages :  IEquatable<PersonWithImages>, IValidatableObject
    {
        ...
        public PersonWithImages(List<RecognizeImage> images = default(List<RecognizeImage>), string name = default(string), string externalId = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>), int? ttl = default(int?), Guid id = default(Guid), string createdAt = default(string), string updatedAt = default(string))
        {
