...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class PersonWithImages : PersonWithImagesData, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="images">Detected Persons..</param>
        public PersonWithImages(string name = default(string), string externalId = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>), string expireAt = default(string), Guid id = default(Guid), string createdAt = default(string), string updatedAt = default(string), List<RecognizeImage> images = default(List<RecognizeImage>)) : base(images)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PersonWithImages and cannot be null");
            }
            this.Name = name;
