...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class QualityDetail :  IEquatable<QualityDetail>, IValidatableObject
    {
        ...
        public QualityDetail(FaceQualityDetailsGroups? groupId = default(FaceQualityDetailsGroups?), FaceQualityConfigName? name = default(FaceQualityConfigName?), List<float> range = default(List<float>), FaceQualityStatus? status = default(FaceQualityStatus?), FaceQualityUnit? unit = default(FaceQualityUnit?), float value = default(float))
        {
