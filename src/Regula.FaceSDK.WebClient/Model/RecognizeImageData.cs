...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// RecognizeImageData
    /// </summary>
    [DataContract(Name = "RecognizeImageData")]
    public partial class RecognizeImageData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecognizeImageData" /> class.
        /// </summary>
        ...
        public RecognizeImageData(float similarity = default(float), float distance = default(float))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecognizeImageData {\n");
