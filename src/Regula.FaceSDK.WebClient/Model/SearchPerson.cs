...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// SearchPerson
    /// </summary>
    [DataContract(Name = "SearchPerson")]
    public partial class SearchPerson : Person, IValidatableObject
    {
        /// <summary>
        ...
        public SearchPerson(SearchDetection detection = default(SearchDetection), List<RecognizeImage> images = default(List<RecognizeImage>), string name = default(string), string externalId = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<Guid> groups = default(List<Guid>), string expireAt = default(string), Guid id = default(Guid), string createdAt = default(string), string updatedAt = default(string)) : base(id, createdAt, updatedAt)
        {
