...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    public partial class SearchPerson :  IEquatable<SearchPerson>, IValidatableObject
    {
        ...
        public SearchPerson(string name = default(string), Object metadata = default(Object), decimal id = default(decimal), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), List<RecognizeImage> images = default(List<RecognizeImage>))
        {
            this.Name = name;
