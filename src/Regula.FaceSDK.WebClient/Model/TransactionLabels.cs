...
namespace Regula.FaceSDK.WebClient.Model
{
    ...
    /// TransactionLabels
    /// </summary>
    [DataContract(Name = "TransactionLabels")]
    public partial class TransactionLabels : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionLabels" /> class.
        /// </summary>
        ...
        public TransactionLabels(string tenant = default(string), string env = default(string))
        {
            this.Tenant = tenant;
            this.Env = env;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionLabels {\n");
